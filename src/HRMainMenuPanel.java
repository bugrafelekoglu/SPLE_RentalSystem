...
public class HRMainMenuPanel extends JPanel{
	...
	public HRMainMenuPanel(){
		...
		btnCategories.addActionListener(new HRMainMenuListener());
		add(btnCategories);
		...
		btnSortItems.addActionListener(new HRMainMenuListener());
		add(btnSortItems);
		...
		btnShowAll.addActionListener(new HRMainMenuListener());
		add(btnShowAll);
		...
		btnUploadAnItem.addActionListener(new HRMainMenuListener());
		add(btnUploadAnItem);
		
		btnLogout = new JButton("Logout");
		btnLogout.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnLogout.setBounds(832, 484, 120, 50);
		btnLogout.addActionListener(new HRMainMenuListener());
		add(btnLogout);
		
		btnSearch = new JButton("Search");
		btnSearch.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnSearch.setBounds(38, 484, 120, 50);
		btnSearch.addActionListener(new HRMainMenuListener());
		add(btnSearch);
		
		searchField = new JTextField();
		searchField.setFont(new Font("Tahoma", Font.PLAIN, 18));
		searchField.setBounds(168, 484, 450, 50);
		searchField.addActionListener(new HRMainMenuListener());
		add(searchField);
